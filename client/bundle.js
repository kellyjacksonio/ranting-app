...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.timerFinished = _this.timerFinished.bind(_this);
        return _this;
    }
    ...
    _createClass(App, [{
        ...
        value: function handleClick() {
            ...
            this.timerID = setInterval(function () {
                _this2.tick();
                console.log(_this2.state.totalSeconds);
            }, 1000);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.minutes,
                    ':',
                    this.state.secondsDisplayed,
                    '!'
                ),
                _react2.default.createElement(
                    'button',
                    { id: this.buttonId, onClick: this.handleClick },
                    'Begin!'
                ),
                _react2.default.createElement('textarea', { id: 'text', defaultValue: 'Click begin to start' })
            );
        }
    }]);
